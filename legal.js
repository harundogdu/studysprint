...
(function () {
  var I18N = {
    en: {
      ...
      // FAQ ek
      sup_q7:`Is there an Apple Watch app?`, sup_a7:`Yes. Install the Watch app to start sprints from your wrist; sessions sync back to your iPhone automatically.`,
      sup_q8:`Can I save sessions to Apple Health?`, sup_a8:`Yes. Turn on "Write to Apple Health" in Settings; completed sessions appear in Health as Mindful Minutes.`,
      // Privacy
      priv_hero_title:`Privacy Policy`, priv_hero_sub:`How Study Sprint Timer handles your data.`, priv_updated:`Last updated: July 23, 2026`,
      ...
      priv_h9:`Contact`, priv_p9:`Questions about this Privacy Policy? Contact us at <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a>.`,
      // Terms
      term_hero_title:`Terms of Service`, term_hero_sub:`The rules for using Study Sprint Timer.`, term_updated:`Last updated: July 23, 2026`,
      ...
      term_h11:`11. Contact`, term_p11:`Questions about these Terms? Contact us at <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a>.`,
      // Footer
    ...
    tr: {
      ...
      sup_q6:`Verilerimi nasıl silerim?`, sup_a6:`Tüm veriler cihazında yerel olarak saklanır. Ayarlar → Verileri Temizle'den ya da uygulamayı kaldırarak her şeyi silebilirsin.`,
            sup_q7:`Apple Watch uygulaması var mı?`, sup_a7:`Evet. Watch uygulamasını kur, sprintleri bileğinden başlat; oturumlar iPhone'una otomatik işlenir.`,
      sup_q8:`Oturumları Apple Sağlık'a kaydedebilir miyim?`, sup_a8:`Evet. Ayarlar'dan "Apple Sağlık'a Yaz"ı aç; tamamlanan oturumlar Sağlık'ta Farkındalık Dakikası olarak görünür.`,
      priv_hero_title:`Gizlilik Politikası`, priv_hero_sub:`Study Sprint Timer verilerini nasıl işler.`, priv_updated:`Son güncelleme: 23 Temmuz 2026`,
      ...
      priv_h2:`Topladığımız Bilgiler`, priv_p2:`<strong>Biz (geliştirici) kişisel verilerini hiçbir sunucuda toplamıyor veya saklamıyoruz.</strong> Tüm uygulama verilerin — çalışma seansları, seriler, istatistikler ve tema/dil gibi ayarlar — yalnızca <strong>cihazında yerel olarak</strong> saklanır. Bize iletilmez. Apple Watch uygulamasını kullanıyorsan verilerin doğrudan iPhone ile Watch arasında eşitlenir; bize hiçbir zaman ulaşmaz.`,
      ...
      priv_h9:`İletişim`, priv_p9:`Bu Gizlilik Politikası hakkında sorun mu var? Bize <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a> adresinden ulaş.`,
      term_hero_title:`Kullanım Şartları`, term_hero_sub:`Study Sprint Timer'ı kullanma kuralları.`, term_updated:`Son güncelleme: 23 Temmuz 2026`,
      ...
      term_h5:`5. Abonelikler ve Satın Alımlar`, term_l5:`<li><strong>Premium</strong>, aylık ve yıllık otomatik yenilenen abonelikler olarak sunulur.</li><li>Ödeme, satın alım onayında Apple Kimliğine tahsil edilir.</li><li>Abonelikler, mevcut dönemin bitiminden en az 24 saat önce iptal edilmediği sürece otomatik yenilenir.</li><li>Abonelikleri istediğin an Apple Kimliği hesap ayarlarından yönetebilir veya iptal edebilirsin.</li><li>Tüm satın alımlar Apple tarafından, Apple'ın şartlarına tabi olarak işlenir ve yönetilir.</li>`,
      ...
      term_h11:`11. İletişim`, term_p11:`Bu Şartlar hakkında sorun mu var? Bize <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a> adresinden ulaş.`,
    ...
    de: {
      ...
      sup_q6:`Wie lösche ich meine Daten?`, sup_a6:`Alle Daten werden lokal gespeichert. Du kannst alles über Einstellungen → Daten löschen oder durch Deinstallation der App entfernen.`,
            sup_q7:`Gibt es eine Apple-Watch-App?`, sup_a7:`Ja. Installiere die Watch-App und starte Sprints vom Handgelenk; Sitzungen werden automatisch mit deinem iPhone synchronisiert.`,
      sup_q8:`Kann ich Sitzungen in Apple Health speichern?`, sup_a8:`Ja. Aktiviere „In Apple Health schreiben" in den Einstellungen; abgeschlossene Sitzungen erscheinen in Health als Achtsamkeitsminuten.`,
      priv_hero_title:`Datenschutzerklärung`, priv_hero_sub:`Wie Study Sprint Timer mit deinen Daten umgeht.`, priv_updated:`Zuletzt aktualisiert: 23. Juli 2026`,
      ...
      priv_h2:`Erhobene Informationen`, priv_p2:`<strong>Wir (der Entwickler) erheben oder speichern keine personenbezogenen Daten auf Servern.</strong> Alle App-Daten — Lernsessions, Serien, Statistiken sowie Einstellungen wie Theme und Sprache — werden <strong>nur lokal auf deinem Gerät</strong> gespeichert und nicht an uns übertragen. Wenn du die Apple-Watch-App nutzt, werden deine Daten direkt zwischen iPhone und Watch synchronisiert und erreichen uns nie.`,
      ...
      priv_h9:`Kontakt`, priv_p9:`Fragen zu dieser Datenschutzerklärung? Kontaktiere uns unter <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a>.`,
      term_hero_title:`Nutzungsbedingungen`, term_hero_sub:`Die Regeln zur Nutzung von Study Sprint Timer.`, term_updated:`Zuletzt aktualisiert: 23. Juli 2026`,
      ...
      term_h11:`11. Kontakt`, term_p11:`Fragen zu diesen Bedingungen? Kontaktiere uns unter <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a>.`,
    ...
    es: {
      ...
      sup_q6:`¿Cómo elimino mis datos?`, sup_a6:`Todos los datos se guardan localmente. Puedes borrar todo en Ajustes → Borrar datos, o desinstalando la app.`,
            sup_q7:`¿Hay una app para Apple Watch?`, sup_a7:`Sí. Instala la app del Watch y empieza sprints desde tu muñeca; las sesiones se sincronizan automáticamente con tu iPhone.`,
      sup_q8:`¿Puedo guardar sesiones en Apple Health?`, sup_a8:`Sí. Activa "Guardar en Apple Health" en Ajustes; las sesiones completadas aparecen en Health como minutos de atención plena.`,
      priv_hero_title:`Política de privacidad`, priv_hero_sub:`Cómo Study Sprint Timer gestiona tus datos.`, priv_updated:`Última actualización: 23 de julio de 2026`,
      ...
      priv_h4b:`Apple Health (opcional)`, priv_p4b:`Si activas la sincronización con Apple Health, la app guarda tus sesiones de enfoque completadas en Apple Health como minutos de atención plena. Solo se escribe la duración de la sesión; la app no lee nada de Health. Tus datos de Health permanecen en tu dispositivo bajo las protecciones de privacidad de Apple, y puedes desactivarlo cuando quieras en Ajustes de iOS → Salud.`,
      ...
      priv_h9:`Contacto`, priv_p9:`¿Preguntas sobre esta Política de privacidad? Escríbenos a <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a>.`,
      term_hero_title:`Términos del servicio`, term_hero_sub:`Las reglas para usar Study Sprint Timer.`, term_updated:`Última actualización: 23 de julio de 2026`,
      ...
      term_h11:`11. Contacto`, term_p11:`¿Preguntas sobre estos Términos? Escríbenos a <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a>.`,
    ...
    fr: {
      ...
      sup_q6:`Comment supprimer mes données ?`, sup_a6:`Toutes les données sont stockées localement. Vous pouvez tout effacer via Réglages → Effacer les données, ou en désinstallant l'app.`,
            sup_q7:`Y a-t-il une app Apple Watch ?`, sup_a7:`Oui. Installez l'app Watch pour lancer des sprints depuis votre poignet ; les sessions se synchronisent automatiquement avec votre iPhone.`,
      sup_q8:`Puis-je enregistrer mes sessions dans Apple Santé ?`, sup_a8:`Oui. Activez « Enregistrer dans Apple Santé » dans les Réglages ; les sessions terminées apparaissent dans Santé comme minutes de pleine conscience.`,
      priv_hero_title:`Politique de confidentialité`, priv_hero_sub:`Comment Study Sprint Timer traite vos données.`, priv_updated:`Dernière mise à jour : 23 juillet 2026`,
      ...
      priv_h4b:`Apple Santé (facultatif)`, priv_p4b:`Si vous activez la synchronisation avec Apple Santé, l'app enregistre vos sessions de concentration terminées dans Apple Santé sous forme de minutes de pleine conscience. Seule la durée de la session est écrite ; l'app ne lit rien dans Santé. Vos données Santé restent sur votre appareil, protégées par Apple, et vous pouvez désactiver cette option à tout moment dans Réglages iOS → Santé.`,
      ...
      priv_h9:`Contact`, priv_p9:`Des questions sur cette Politique de confidentialité ? Contactez-nous à <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a>.`,
      term_hero_title:`Conditions d'utilisation`, term_hero_sub:`Les règles d'utilisation de Study Sprint Timer.`, term_updated:`Dernière mise à jour : 23 juillet 2026`,
      ...
      term_h11:`11. Contact`, term_p11:`Des questions sur ces Conditions ? Contactez-nous à <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a>.`,
    ...
    ru: {
      ...
      sup_q6:`Как удалить мои данные?`, sup_a6:`Все данные хранятся локально. Вы можете очистить всё в Настройки → Очистить данные или удалив приложение.`,
            sup_q7:`Есть ли приложение для Apple Watch?`, sup_a7:`Да. Установите приложение для Watch и запускайте спринты с запястья; сессии автоматически синхронизируются с iPhone.`,
      sup_q8:`Можно ли сохранять сессии в Apple Здоровье?`, sup_a8:`Да. Включите «Запись в Apple Здоровье» в настройках; завершённые сессии появятся в Здоровье как минуты осознанности.`,
      priv_hero_title:`Политика конфиденциальности`, priv_hero_sub:`Как Study Sprint Timer обрабатывает ваши данные.`, priv_updated:`Последнее обновление: 23 июля 2026 г.`,
      ...
      priv_h2:`Какие данные мы собираем`, priv_p2:`<strong>Мы (разработчик) не собираем и не храним ваши персональные данные на серверах.</strong> Все данные приложения — сессии, серии, статистика и настройки (тема, язык) — хранятся <strong>только локально на вашем устройстве</strong> и не передаются нам. Если вы используете приложение для Apple Watch, данные синхронизируются напрямую между iPhone и Watch и никогда не попадают к нам.`,
      ...
      priv_h4b:`Apple Здоровье (по желанию)`, priv_p4b:`Если включить синхронизацию с Apple Здоровье, приложение записывает завершённые фокус-сессии в Apple Здоровье как минуты осознанности. Записывается только длительность сессии; приложение ничего не читает из Здоровья. Данные Здоровья остаются на вашем устройстве под защитой Apple, и вы можете отключить это в любой момент в Настройках iOS → Здоровье.`,
      ...
      priv_h9:`Контакты`, priv_p9:`Вопросы по этой Политике конфиденциальности? Напишите нам на <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a>.`,
      term_hero_title:`Условия использования`, term_hero_sub:`Правила использования Study Sprint Timer.`, term_updated:`Последнее обновление: 23 июля 2026 г.`,
      ...
      term_h11:`11. Контакты`, term_p11:`Вопросы по этим Условиям? Напишите нам на <a href="mailto:support@studysprinttimer.com">support@studysprinttimer.com</a>.`,
